        ...
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30 pd-20">
                ...
                <div class="pull-right">
                    <a href="{{ route('meet.create') }}" class="btn btn-primary btn-sm scroll-click collapsed"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" {{ $item->status == 1 ? 'checked' : '' }}
                                            {{ $item->status == 1 ? 'disabled' : '' }} class="switch-btn"
                                            data-color="#0099ff" data-id="{{ $item->id }}">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item" href="{{ route('meet.show', $item) }}"><i
                                                        class="dw dw-eye"></i> View</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('meet-attendance.index', $item) }}"><i
                                                        class="dw dw-agenda1"></i> Peserta Rapat</a>

                                                @if ($item->status != 1)
                                                    <a class="dropdown-item"
                                                        href="{{ route('meet-result.index', $item) }}"><i
                                                            class="dw dw-list"></i> Hasil Rapat</a>
                                                    <a class="dropdown-item" href="{{ route('meet.edit', $item) }}"><i
                                                            class="dw dw-edit2"></i> Edit</a>
                                                @endif


                                                <a class="dropdown-item delete" id="delete" href="#"
                                                    data-id="{{ $item->id }}"><i class="dw dw-delete-3"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
